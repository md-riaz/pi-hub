...
class EditCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final removed =
        event.metadata['deletions'] ?? event.metadata['removed'] ?? 0;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: HubTheme.blue.withValues(alpha: 0.08),
        border: Border.all(color: HubTheme.blue.withValues(alpha: 0.2)),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            height: 36,
            decoration: BoxDecoration(
              color: HubTheme.blue.withValues(alpha: 0.1),
            ...
            child: Column(
              ...
              children: [
                ...
                if (summary.isNotEmpty) ...[
                  ...
                  Text(
                    summary,
                    style: HubTheme.caption.copyWith(fontSize: 12, height: 1.4),
                  ),
                ],
                if (onViewDiff != null) ...[
