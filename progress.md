...
- Expanded repository README and Flutter app README with professional clone/install/use/build/API/troubleshooting instructions using generic local clone paths.
